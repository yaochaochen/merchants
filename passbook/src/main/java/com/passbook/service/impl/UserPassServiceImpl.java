...
public class UserPassServiceImpl implements IUserPassService {
    ...
    public Response getUserPassInfo(Long userId) throws Exception {
        ...
        return getUserPassInfoByStatus(userId, PassStatus.UNUSED);
    }

    @Override
    public Response getUserUsedPassInfo(Long userId) throws Exception {
        return getUserPassInfoByStatus(userId, PassStatus.USED);
    }

    @Override
    public Response getUserAllPassInfo(Long userId) throws Exception {
        return getUserPassInfoByStatus(userId, PassStatus.ALL);
    }
...
//        }
    ...
    private Response getUserPassInfoByStatus(Long userId, PassStatus passStatus) throws Exception {
        //构建前缀
